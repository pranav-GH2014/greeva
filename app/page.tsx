...
export default function HomePage() {
  return (
   <div className="bg-[#FAF9F6] min-h-screen">
      {/* 1. Hero Slider Section (New Arrivals) */}
      <section className="w-full">
        <HeroSlider />
      </section>

      {/* 2. Original Hero Text Section (Optional: Move below or keep as a Welcome) */}
      <section className="relative px-6 lg:px-8 py-16 flex flex-col items-center text-center bg-gray-50">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 lg:gap-x-8">
          {/* Category Card */}
          <div className="group relative border rounded-xl p-4 hover:shadow-md transition">
            <div className="h-60 w-full overflow-hidden rounded-md bg-gray-200 group-hover:opacity-75 flex items-center justify-center">
